...
namespace svn
{
typedef std::function<void(const char *, const char *, const apr::pool &)> get_changelists_callback;

typedef std::function<void(const svn_commit_info_t *, const apr::pool &)> commit_callback;

typedef std::function<void(const char *, const svn_client_info2_t *, const apr::pool &)> info_callback;

typedef std::function<void(const svn_commit_info_t *, const apr::pool &)> remove_callback;

typedef std::function<void(const char *, const svn_client_status_t *, const apr::pool &)> status_callback;
...
class client : public std::enable_shared_from_this<client>
{
  ...
  protected:
    ...
    virtual void notify(const svn_wc_notify_t *notify) = 0;
